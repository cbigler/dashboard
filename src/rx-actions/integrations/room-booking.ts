...
export async function integrationsSpaceMappingUpdate(dispatch, service, space, service_space_id) {
  // Decide if a spacemapping needs to be created or can be updated
  const activeSpaceMapping = space.space_mappings.length > 0 ? space.space_mappings[0] : null;
